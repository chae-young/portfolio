        ...
        <ProfileWrap>
          ...
          >
            <div>
              ...
              <p>
                React 기반 신규 서비스 구축 프로젝트를 리딩했으며, Vue.js 레거시
                서비스 운영도 경험했습니다. 4년의 UI 개발 경험을 바탕으로 디자인
                의도와 사용자 흐름을 빠르게 파악하고, 재사용 가능한 컴포넌트
                구조로 구현합니다. 재사용성과 성능 최적화에 관심을 갖고 합성
                컴포넌트 패턴, Tanstack Query 캐싱 전략, 빌드 최적화 등을 적용한
                결과 중복 코드 60% 감소, LCP 54% 개선 등을 달성했습니다. 기술
                블로그를 운영하며 지속적으로 학습하고 지식을 공유합니다.
              </p>
            </div>
