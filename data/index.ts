...
export const CAREER_DATA: CareerData[] = [
  {
    ...
    year: "2025.05 - 재직중",
    company: "(주)디플루이드",
    companyInfo: "다양한 클라이언트의 웹 서비스 운영,구축을 담당하는 프론트엔드 전문 에이전시",
    projects: [
      {
        name: '대기업(LG Uplus) 클라이언트 웹서비스 운영',
        date: '2025.04 - 진행중',
        skill: 'Vue, Nuxt',
        desc: [
          {
            title: "홈 가입신청 페이지 리뉴얼 개발 참여하며 사용자 가입 플로우 변경에 따른 UI 구조 및 상태 흐름 개선",
            detail: [
              "데이터 응답 스펙 변경에 대응하여 기존 비즈니스 로직 재설계"
            ]
          },
          {
            title: "정책(단통법 폐지) 변경에 따라 요금제/혜택 노출 방식이 달라지는 UI 컴포넌트 재설계 및 신규 API 연동을 포함한 비즈니스 로직 개선",
            detail: []
          },
        ]
      },
      ...
      },
      {
        ...
        desc: [
          {
            title: "Vue.js 기반 기존 APP 전용 UI를 분석하여 반응형 스타일로 구축(1인 전담)",
            detail: []
          },
          {
            title: "타이트한 프로젝트 일정속에 기간 내(1개월내 앱→ 웹 반응형 전환) 작업 완수",
            detail: []
          },
        ]
      },
      {
        ...
        desc: [
          {
            title: "런칭 전 내부 기능테스트 및 코드 분석을 통해 10건 이상의 이슈 사전 발견 및 수정으로 안정적 런칭 기여",
            detail: []
          },
          {
            title: "중복 코드 제거 및 안티 패턴 코드 리팩토링으로 코드 안정성 개선",
            detail: []
          },
          {
    ...
    projects: [
      {
        ...
        desc: [
          ...
          {
            title: "브랜드 무드에 최적화된 인터랙션 구현으로 사용자 경험(UX) 향상",
            detail: []
          },
        ]
      },   
    ...
    projects: [
      {
        ...
        desc: [
          {
            title: "시맨틱 마크업과 BEM 방법론을 적용한 유지보수성 높은 마크업 구조 설계",
            detail: [
              "스네이크 케이스 클래스에서 BEM 방식으로 개선 및 문서화"
            ]
          },
          {
